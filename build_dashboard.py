...
<body>
  ...
  <script>
    ...
    function renderHighlights() {{
        ...
        return items.map(item => `
          <div class="highlight-item">
            <div class="highlight-info">
              <span class="highlight-name" title="${{item.linha || item.nome}}">${{item.linha || item.nome}}</span>
      ...
      document.getElementById('listAceleradores').innerHTML = renderList(destaques.aceleradores_linhas || destaques.aceleradores || [], true);
      document.getElementById('listDetratores').innerHTML = renderList(destaques.detratores_linhas || destaques.detratores || [], false);
    }}
